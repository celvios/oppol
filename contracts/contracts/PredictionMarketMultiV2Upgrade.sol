...
/**
 * @title PredictionMarketMultiV2Upgrade
 ...
 */
contract PredictionMarketMultiV2Upgrade is 
    Initializable, 
    OwnableUpgradeable, 
    ...
    UUPSUpgradeable 
{
     ...
     * Used to rescue funds from orphaned custodial wallets whose private keys were deleted in DB wipe
     */
