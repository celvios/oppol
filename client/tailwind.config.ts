    ...
    theme: {
        extend: {
            colors: {
                ...
                primary: "#02c7fc", // Bright Blue (User Requested)
            },
            fontFamily: {
            ...
            backgroundImage: {
                ...
                "gradient-cyan": "linear-gradient(135deg, #02c7fc 0%, #02a3d1 100%)", // Adjusted gradient end for depth
            ...
            keyframes: {
                ...
                pulseGlow: {
                    "0%, 100%": { opacity: "1", boxShadow: "0 0 10px rgba(2, 199, 252, 0.2)" },
                    "50%": { opacity: "0.8", boxShadow: "0 0 20px rgba(2, 199, 252, 0.5)" }
                }
            },
        },
    },
